...
int makeWindow(int, char**)
{
    ...
    colors[ImGuiCol_Border] = ImVec4(0.25f, 0.25f, 0.25f, 0.25f);
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(1.00f, 1.00f, 1.00f, 0.85f);

    colors[ImGuiCol_SliderGrab] = ImVec4(0.85f, 0.85f, 0.85f, 0.60f);
    ...
    colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.10f, 0.10f, 0.70f);

    colors[ImGuiCol_Text] = ImVec4(1.0f, 1.0f, 1.0f, 1.0f); // Pure white
    colors[ImGuiCol_TextDisabled] = ImVec4(0.6f, 0.6f, 0.6f, 1.0f); // Lighter gray

    colors[ImGuiCol_Separator] = ImVec4(0.30f, 0.30f, 0.30f, 0.50f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.50f, 0.50f, 0.50f, 0.75f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.75f, 0.75f, 0.75f, 0.95f);

    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.05f, 0.05f, 0.05f, 0.60f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.25f, 0.25f, 0.25f, 0.80f);
    ...
    while (!done)
    {
        ...
        ImGui::SetNextWindowSize(ImVec2(500, 650), ImGuiCond_Once);
        ...
        if (gui::showImGuiWindow)
        {
            ...
            ImGui::Begin("Nullbit", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
            ...
            if (ImGui::BeginTabBar("MainTabs"))
            {
                if (ImGui::BeginTabItem("Home"))
                {
                    ...
                    ImGui::Text("Welcome to Nullbit External!");
                ...
                if (ImGui::BeginTabItem("Aimbot"))
                {
                    ...
                    ImGui::BeginChild("AimbotMain", ImVec2(311, 170), true);
                    ...
                    ImGui::SliderFloat("##AimbotSmoothness", &aimbot::smoothness, 1.0f, 10.0f, "%.1f");

                    ImGui::EndChild();

					ImGui::SameLine();

					ImGui::BeginChild("Aimbot Checks", ImVec2(155, 170), true);

                    ImGui::Text("Checks");
                    ImGui::Checkbox("Team Check", &aimbot::TeamCheck);
                    ImGui::Checkbox("Wall Check", &aimbot::WallCheck);
                ...
                {
                    ImGui::BeginChild("ESPMain", ImVec2(233, 190), true);
                    ...
                    ImGui::BeginChild("ESPOther", ImVec2(233, 190), true);
                    ImGui::Text("Checks");
        ...
        if (showWatermark)
        {
            ...
            const char* text = "Nullbit | Status: Undetected | FPS: %.0f";
            char buf[256];
