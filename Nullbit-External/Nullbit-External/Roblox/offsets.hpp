...
namespace offsets {
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x68D7310;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x68D7308;
    ...
    inline constexpr uintptr_t ForceNewAFKDuration = 0x1F8; // 0x579DA3C
    inline constexpr uintptr_t FramePositionOffsetX = 0x3C4;
    inline constexpr uintptr_t FramePositionOffsetY = 0x3CC;
    inline constexpr uintptr_t FramePositionX = 0x3C0;
    inline constexpr uintptr_t FramePositionY = 0x3C8;
    ...
    inline constexpr uintptr_t GameLoaded = 0x420;
    ...
    inline constexpr uintptr_t JobsPointer = 0x69A7500;
    ...
    inline constexpr uintptr_t MaterialType = 0x2D8;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x694ddc4;
    ...
    inline constexpr uintptr_t PartSize = 0x25C;
    inline constexpr uintptr_t Ping = 0xD0;
    inline constexpr uintptr_t PlaceId = 0x1A0;
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x68B4DF0;
    inline constexpr uintptr_t PlayerMouse = 0xC18;
    ...
    inline constexpr uintptr_t PrimitivesPointer1 = 0x3B0;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x6719638;
    ...
    inline constexpr uintptr_t WorkspaceToWorld = 0x3B0;
